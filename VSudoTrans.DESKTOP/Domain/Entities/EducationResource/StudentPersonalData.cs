        ...
        public string PhotoUrl
        {
            get
            {
                if (!string.IsNullOrEmpty(Photo))
                    return "https://vsudotechstorage.blob.core.windows.net/VSudoTrans/student/" + Photo;
                else
                    return string.Empty;
            }
            set
        ...
        public string SignatureUrl
        {
            get
            {
                if (!string.IsNullOrEmpty(Signature))
                    return "https://vsudotechstorage.blob.core.windows.net/VSudoTrans/student/" + Signature;
                else
                    return string.Empty;
            }
            set
