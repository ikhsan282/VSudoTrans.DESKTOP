...
namespace VSudoTrans.DESKTOP.Transaction.Travel
{
    public partial class frmTripScheduleDV : frmBaseDV
    {
        ...
        public frmTripScheduleDV(object id, string endPoint, object copy = null)
        {
            ...
            _BindingSourceDetail.DataSource = new List<TripScheduleDetail>();
        ...
        protected override void DisplayEntity<T>()
        {
            ...
            if (_TripSchedule != null)
            {
                ...
                _BindingSourceDetail.DataSource = _TripSchedule.TripScheduleDetails.ToList(); // setelah totaltiket agar aman
            }
        }
        ...
        protected override void InitializeSearchLookup()
        {
            ...
            PopupEditHelper.General<TravelTicketBooking>(fEndPoint: "/TravelTicketBookings", fTitle: "Tiket Pemesanan", fControl: TravelTicketBookingPopUp, fCascade: PickupCityPopUp,
                fCascadeMember: "PickupPointCityId", fSelect: "id,Date,Time,DocumentNumber,TotalTicket,TotalPrice", fExpand: "PickupPointCity($select=Name),DeliveryPointCity($select=Name)", fDisplayText: "DocumentNumber",
        ...
        protected override void ActionEndEdit()
        {
            ...
            List<TripScheduleDetail> tripScheduleDetails = _BindingSourceDetail.DataSource as List<TripScheduleDetail>;
            _TripSchedule.TripScheduleDetails = tripScheduleDetails;
