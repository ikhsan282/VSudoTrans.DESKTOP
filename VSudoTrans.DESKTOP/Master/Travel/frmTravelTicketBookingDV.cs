...
namespace VSudoTrans.DESKTOP.Master.Travel
{
    public partial class frmTravelTicketBookingDV : frmBaseDV
    {
        ...
        protected override void InitializeSearchLookup()
        {
            ...
            PopupEditHelper.General<Passenger>("/Passengers", PassengerPopUp, fCascade: CompanyPopUp, fCascadeMember: "CompanyId", fDisplaycolumn: "Code;Name;PhoneNumber", fCaptionColumn: "Kode;Nama;Nomor Telepon");
