...
{
    public partial class frmDebitLV : frmBaseFilterLV
    {
        public frmDebitLV()
        {
            InitializeComponent();
        ...
        {
            var fileExcel = HelperRestSharp.DownloadFile("vsts", "import/Import Budget Transaction.xlsx");
        ...
        protected override void ActionRefresh<T>(string endPoint = "")
        {
            ...
            OdataFilter = $"Indicator eq '{EnumTransactionIndicator.Debit}' and CompanyId eq {HelperConvert.Int(AssemblyHelper.GetValueProperty(FilterPopUp3.EditValue, "Id"))}";
        ...
        {
            FormDetail = new frmDebitDV(EntityId, EndPoint, fCopy);
