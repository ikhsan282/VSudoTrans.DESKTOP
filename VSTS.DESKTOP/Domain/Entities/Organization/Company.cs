        ...
        public string LogoUrl
        {
            get
            {
                if (!string.IsNullOrEmpty(Logo))
                    return "https://vsudotechstorage.blob.core.windows.net/vsts/company/" + Logo;
                else
                    return string.Empty;
            }
            set
        ...
        public string WatermarkUrl
        {
            get
            {
                if (!string.IsNullOrEmpty(Watermark))
                    return "https://vsudotechstorage.blob.core.windows.net/vsts/company/" + Watermark;
                else
                    return string.Empty;
            }
            set
        ...
        public string WatermarkPaidUrl
        {
            get
            {
                if (!string.IsNullOrEmpty(WatermarkPaid))
                    return "https://vsudotechstorage.blob.core.windows.net/vsts/company/" + WatermarkPaid;
                else
                    return string.Empty;
            }
            set
        ...
        public string WatermarkUnpaidUrl
        {
            get
            {
                if (!string.IsNullOrEmpty(WatermarkUnpaid))
                    return "https://vsudotechstorage.blob.core.windows.net/vsts/company/" + WatermarkUnpaid;
                else
                    return string.Empty;
            }
            set
